...
const Projects = () => {
  ...
  return (
    <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center',padding:"2px 10px" }}>
      <Grid
        container
        spacing={2}
      ...
      >
        <Grid xs={12} md={12} lg={12} item>
          <Typography variant="h3" sx={{ fontWeight: "bold", color: theme.palette.primary.main }}>My Projects</Typography>
